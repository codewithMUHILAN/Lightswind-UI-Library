...
const ButtonGroupIcon = () => {
    return (
        <div className="flex justify-center items-center space-x-4 py-8">
            <button className="group relative inline-block px-8 py-3 text-white bg-indigo-600 rounded-l-lg shadow-md overflow-hidden hover:bg-indigo-700 transition-all duration-300">
            ...
            <button className="group relative inline-block px-8 py-3 text-white bg-primarylw-2 shadow-md overflow-hidden hover:bg-primary transition-all duration-300">
            ...
            <button className="group relative inline-block px-8 py-3 text-white bg-green-600 rounded-r-lg shadow-md overflow-hidden hover:bg-green-700 transition-all duration-300">
