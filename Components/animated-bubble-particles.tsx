...
const AnimatedBubbleParticles: React.FC<AnimatedBubbleParticlesProps> = ({
    ...
    (ctx: CanvasRenderingContext2D, b: Bubble, t: number) => {
      ...
      if (enableGlow && b.glowIntensity > 0) {
        ...
        const glowGrad = ctx.createRadialGradient(
          b.x + wobbleX, b.y, b.radius * 0.1,
          b.x + wobbleX, b.y, b.radius + b.glowIntensity
        );
        glowGrad.addColorStop(0, b.color);
        glowGrad.addColorStop(1, "transparent");
        ctx.fillStyle = glowGrad;
        ctx.beginPath();
        ctx.arc(b.x + wobbleX, b.y, b.radius + b.glowIntensity, 0, Math.PI * 2);
        ctx.fill();
        ctx.restore();
      }
      ...
      const bodyGrad = ctx.createRadialGradient(
        b.x + wobbleX - b.radius * 0.3, b.y - b.radius * 0.3, b.radius * 0.05,
        b.x + wobbleX, b.y, b.radius
      );
      ...
      const specGrad = ctx.createRadialGradient(
        b.x + wobbleX - b.radius * 0.28, b.y - b.radius * 0.35, 0,
        b.x + wobbleX - b.radius * 0.28, b.y - b.radius * 0.35, specR
      );
      ...
      ctx.beginPath();
      ctx.arc(b.x + wobbleX - b.radius * 0.28, b.y - b.radius * 0.35, specR, 0, Math.PI * 2);
      ctx.fill();

      // Bottom reflection
      const refGrad = ctx.createRadialGradient(
        b.x + wobbleX + b.radius * 0.2, b.y + b.radius * 0.5, 0,
        b.x + wobbleX + b.radius * 0.2, b.y + b.radius * 0.5, b.radius * 0.25
      );
      refGrad.addColorStop(0, `rgba(255,255,255,0.18)`);
      refGrad.addColorStop(1, `rgba(255,255,255,0)`);
      ctx.fillStyle = refGrad;
      ctx.beginPath();
      ctx.arc(b.x + wobbleX + b.radius * 0.2, b.y + b.radius * 0.5, b.radius * 0.25, 0, Math.PI * 2);
      ctx.fill();
  ...
  useEffect(() => {
    ...
    const tick = (ts: number) => {
      ...
      if (
        ...
        bubblesRef.current.push(
          createBubble(w, h, colorHueStart, colorHueEnd, saturation, lightness, minRadius, maxRadius)
        );
    ...
    dims, colorHueStart, colorHueEnd, saturation, lightness,
    maxBubbles, spawnInterval, minRadius, maxRadius, speed,
    mouseRepelRadius, mouseInteraction, enableGlow, drawBubble,
  ]);
